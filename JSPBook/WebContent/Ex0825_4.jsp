...
<title>Ex0825_4</title>
</head>
<body>
<%
	MultipartRequest multi = new MultipartRequest(request, "D:\\WebProg\\upload"
			, 5*1024*1024, "UTF-8", new DefaultFileRenamePolicy());
	String title1 = multi.getParameter("title1");
	String title2 = multi.getParameter("title2");
	
	Enumeration files = multi.getFileNames(); //file이 여러개 넘어올 때
	String name2 = (String) files.nextElement();
	String fileName2 = multi.getFilesystemName(name2);
	String type2 = multi.getContentType(name2);
	
	String name1 = (String) files.nextElement();
	String fileName1 = multi.getFilesystemName(name1);
	String type1 = multi.getContentType(name1);
	

	/* String original = multi.getOriginalFileName(name); */
	/* File file = multi.getFile(name); //파일 정보 추출 */
