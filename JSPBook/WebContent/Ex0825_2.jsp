...
<title>Ex0825_2</title>
</head>
<body>
<%
	request.setCharacterEncoding("UTF-8"); //전송 방식 설정
	...
	<div id="content">
		<section id="main_section">
			<article class="main_article">
				<h1>Main Article</h1>
				<%
					while(paramNames.hasMoreElements()) { //다음 요소가 있는가? true
						String name = (String) paramNames.nextElement(); //다음 요소의 name key에 해당. Object로 넘어오므로 casting
						out.print("<p>" + name + " : ");
						String paramValue = request.getParameter(name); //해당 name의 value
