		...
		<section id="main_section">
			...
			<article class="main_article">
				...
				<form action="./Ex0824_3.jsp" method="post">
					...
					<p>Hobbies :  
						Reading books<input type="checkbox" name="hobby" value="Reading books" checked>
						Working out<input type="checkbox" name="hobby" value="Working out">
						Movies<input type="checkbox" name="hobby" value="Movies"></p>
					<p><select name="city">
