		...
		<div id="section">
			<div id="article">
				<form action="./insert_ok.jsp" method="post">
					<table>
						<tr>
							<td class="td_title_long" colspan="2">게시글 쓰기</td>
						</tr>
						<tr>
							<td class="td_title_base">제목</td>
							<td class="td_contents"><input type="text" name="bm_subject"></td>
						</tr>
						<tr>
							<td class="td_title_base">아이디</td>
							<td class="td_contents"><input type="text" name="m_id" value="<%=(String)session.getAttribute("m_id") %>" readonly></td>
						</tr>

						<tr>
							<td class="td_title_big">내용</td>
							<td class="td_contents_big">
							<textarea name="bm_contents" cols="50" rows="10"></textarea>
							</td>
						</tr>
						<tr>
