		...
		<div id="section">
			<div id="article">
				<form action="./insert_ok.jsp" method="post">
					<table>
						<tr>
							<td class="td_title_long" colspan="2">방명록 회원가입</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="td_contents"><input type="text" name="m_name"></td>
						</tr>
						<tr>
							<td class="td_title_base">주소</td>
							<td class="td_contents"><input type="text" name="m_addr"></td>
						</tr>
						<tr>
							<td class="td_title_base">휴대전화</td>
							<td class="td_contents"><input type="text" name="m_phone"></td>
						</tr>
						<tr>
						...
						<tr>
							<td class="td_title_long" colspan="2"><input type="submit" value="가입하기"></td>
						</tr>
					</table>
				</form>
			</div>
