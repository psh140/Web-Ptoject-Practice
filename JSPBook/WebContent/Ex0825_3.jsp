		...
		<section id="main_section">
			<article class="main_article">
				...
				<form action="Ex0825_4.jsp" method="post" enctype="multipart/form-data">
					<h3>제목 1:<input type="text" name="title1"></h3>
					<h3>파일 1:<input type="file" name="file1"></h3>
					
					<h3>제목 2:<input type="text" name="title2"></h3>
					<h3>파일 2:<input type="file" name="file2"></h3>
