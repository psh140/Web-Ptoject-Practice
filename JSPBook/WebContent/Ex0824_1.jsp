...
<%!
	...
	String greeting = "Welcome JSP!!";
	String greeting2 = "JSP2 Hello!!";
%>
<body>
<%-- scriptlet annotation --%>
	<!-- html annotation -->
	<% //Java annotation %>
	<%
				Date d = new Date();
	...
	<div id="content">
		<section id="main_section">
			<article class="main_article">
				<h1>Main Article</h1>
				<p>화요일인 18일은 전국이 대체로 맑은 가운데 전국 대부분 지역에 폭염주의보 또는 폭염경보가 내려지는 등
					무더위가 예상된다. 18일 오전 5시 현재 기온은 서울 24.5도, 인천 24.1도, 수원 23.5도, 춘천 24.9도,
					강릉 27도, 청주 26도, 대전 25.8도, 전주 25.9도, 광주 25.2도, 제주 26.9도, 대구 24.8도,
					부산 26.5도, 울산 24.3도, 창원 25.9도 등이다. 낮 최고 기온은 31∼38도로 예보됐다. 높은 습도로 인해
					체감온도가 35도 안팎까지 오르겠고, 야간에는 전국 대부분 지역에 열대야 현상이 나타나 건강관리에 유의해야 한다.미세먼지
					농도는 부산·울산에서 '나쁨', 그 밖의 권역은 '좋음'∼'보통' 수준을 보이겠다. 바다의 물결은 동해 앞바다에서
					0.5∼1ｍ, 서해 앞바다에서 0.5ｍ, 남해 앞바다에서 0.5∼1ｍ로 일겠다.</p>
					<% out.print(addNum(5, 6) + "<br>"); %>
					<% 
						int total = 0;
						for(int i = 0; i < 10; i++) {
							if(i % 2 == 0) {
						...
						String totalString = "<p>1 ~ 10 total : " + total + "</p>";
						
					%>
					
					<h1><%= "result is : " + addNum(55, 2) %></h1>
			</article>
			<article class="main_article">
				<h1>Main Article</h1>
				<p>화요일인 18일은 전국이 대체로 맑은 가운데 전국 대부분 지역에 폭염주의보 또는 폭염경보가 내려지는 등
