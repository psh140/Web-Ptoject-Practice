...
<%
	...
	String sql = null;
	String url = "jdbc:oracle:thin:@192.168.0.80:1521:orcl"; // ip:port number:SID
	String user = "madang";
	...
	try {
		...
		pstmt.setString(1, username); //첫번째 필드에 추가
		pstmt.setInt(2, Integer.parseInt(age));
		pstmt.executeUpdate(); //query 실행(insert, update, delete)
	} catch(Exception e) {
		...
		response.sendRedirect("./OracleDBPrac.jsp");
	}
%>
