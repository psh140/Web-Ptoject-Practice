...
<body>
	...
	//헤더 정보는 설정해주지 않아도 항상 넘어감. ip등
	response.setDateHeader("date", 1L);
	request.setCharacterEncoding("utf-8"); //한글처리. 정보를 주고받는 과정에서 필수!
	String hostValue = request.getHeader("host");
	String alValue = request.getHeader("accept-language");
	/* String name = request.getParameter("name"); //name 변수 일치시켜야함
	String password = request.getParameter("password"); */
	...
	<header id="main_header">
		<div id="title">
			<h1>UI 프로그래밍</h1>
			<h2>박 상 혁</h2>
			<h4><jsp:include page="header.jsp"></jsp:include></h4>
		</div>
		<nav id="main_gnb">
			<ul>
				<li><a href="#">Web</a></li>
		...
		<section id="main_section">
			...
			<article class="main_article">
				...
				<p>
					...
					out.print("language : " + alValue + "<br>");
					%>
				
				<p><%="접속자 ip : " + request.getRemoteAddr()%>
			</article>
			<article class="main_article">
				<h1>Main Article</h1>
				<p> ID : <%=id%>
